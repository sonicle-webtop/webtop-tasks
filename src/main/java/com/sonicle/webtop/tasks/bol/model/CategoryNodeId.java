...
public class CategoryNodeId extends CId {
	...
	protected CategoryNodeId(CId.AbstractBuilder builder) {
		super(builder);
	}
	
	public CategoryNodeId(String nodeId) {
		super(nodeId, 3);
	}
	...
	public static CategoryNodeId build(final Type type, final UserProfileId originProfileId) {
		return build(Check.notNull(type, "type"), Check.notNull(originProfileId, "originProfileId").toString());
	}
	
	public static CategoryNodeId build(final Type type, final UserProfileId originProfileId, final int folderId) {
		return new Builder()
	...
	private static class Builder extends CId.AbstractBuilder<Builder, CategoryNodeId> {
		@Override
		public CategoryNodeId build() {
			return new CategoryNodeId(this);
		}
	}
}
