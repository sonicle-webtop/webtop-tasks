...
public class Dav extends DavApi {
	...
	private DavObjectChanged createDavObjectChanged(TaskObject taskObject) {
	...
	private DavObjectsChanges createDavObjectsChanges(DateTime lastRevisionTimestamp, Delta<TaskObject> delta) {
	...
	private TasksManager getManager(UserProfileId targetProfileId) {
		...
		RunContext.setSoftwareName("rest-dav");
		return manager;
	}
