...
public class Eas extends EasApi {
	...
	public Response getMessagesStats(String folderId, String cutoffDate) {
		...
		try {
			Category cat = manager.getCategory(Integer.valueOf(folderId));
	...
	public Response getMessage(String folderId, String id) {
		...
		try {
			Category cal = manager.getCategory(Integer.valueOf(folderId));
	...
	public Response addMessage(String folderId, ApiSyncTaskUpdate body) {
		...
		try {
			...
			newTask.setCategoryId(Integer.valueOf(folderId));
